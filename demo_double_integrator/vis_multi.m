...
iv_RAS =  importdata('verified_RAS_opt_fine_multi.mat');
...
CLVF = visSetIm(g_grid,V_clvf,'m',0.5,exrClvf);
...
lg1 = legend([OBS,GOAL,GOAL2,AVOID,REACH,REACH2,CLVF,TRAJ],...
    {'obstacle', 'target1', 'target2', 'avoid set', 'reach set1',...
    'reach set2','$\mathcal I_M$','traj'}, ...
